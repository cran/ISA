...
.onAttach<-function(libname,pkgname){
  ...
  cat(paste("Package",sQuote(pkg.info["Package"]),"version",pkg.info["Version"],"loaded and ready to use.",sep=" "),"\n\n")
  cat(paste(sQuote(pkg.info["Package"]),pkg.info["Description"],sep=" "),"\n")
